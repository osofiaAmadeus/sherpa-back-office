...
@RestController
@RequestMapping("/api/sherpa-back-office-kafka")
public class SherpaBackOfficeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SherpaBackOfficeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SherpaBackOfficeKafkaResource(KafkaProperties kafkaProperties) {
